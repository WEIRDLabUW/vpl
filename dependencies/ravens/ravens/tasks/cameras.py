...
class RealSenseD415():
  ...
  # New desired resolution
  new_image_size = (120, 160)

  # Original resolution and intrinsics
  original_image_size = (480, 640)
  original_intrinsics = (450., 0, 320., 0, 450., 240., 0, 0, 1)

  # Calculate scale factors
  scale_width = new_image_size[1] / original_image_size[1]
  scale_height = new_image_size[0] / original_image_size[0]

  # Adjust intrinsics
  new_fx = original_intrinsics[0] * scale_width
  new_fy = original_intrinsics[4] * scale_height
  new_cx = original_intrinsics[2] * scale_width
  new_cy = original_intrinsics[5] * scale_height

  new_intrinsics = (new_fx, 0, new_cx, 0, new_fy, new_cy, 0, 0, 1)

  image_size = new_image_size#(120, 160)
  intrinsics = new_intrinsics#(450., 0, 320., 0, 450., 240., 0, 0, 1)
