...
flags.DEFINE_bool("vae_sampling", True, "Sample from VAE.")
...
flags.DEFINE_integer("sample_freq", 10, "sample_freq")
flags.DEFINE_bool("next_step", False, "next step")
flags.DEFINE_float("exp_scaling_temp", 1.0, "exp_scaling_temp")
...
def update_observation(observation, mode, append_goal, model_type, latent, goals=None):
    if append_goal:
        goal = np.array(goals[mode][:2])
