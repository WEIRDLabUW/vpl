...
from jaxrl_m.evaluation import supply_rng, evaluate, evaluate_sort
import jaxrl_m.envs
from jaxrl_m.dataset import Dataset
import jaxrl_m.learners.rwr as learner
...
def update_observation(observation, mode, append_goal, model_type, reward_model, goals):
    if append_goal:
