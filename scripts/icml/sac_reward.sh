...
#SBATCH --export=all
#SBATCH --output=slurm_icml/%j-out.txt   # where STDOUT goes
#SBATCH --error=slurm_icml/%j-err.txt    # where STDERR goes
#SBATCH --array=0-3
